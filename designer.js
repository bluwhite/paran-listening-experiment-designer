...
let items=[],files=new Map(),basenames=new Map(),allProjectFiles=[],testRunner=null,projectDirHandle=null,currentAnalysis=null;
...
function renderParticipantStats(rows){$("participantTab").innerHTML=tableHtml([{key:"participantId",label:"참가자"},{key:"totalQuestions",label:"전체 문항"},{key:"answered",label:"응답"},{key:"unanswered",label:"미응답"},{key:"correct",label:"정답"},{key:"incorrect",label:"오답"},{key:"unrecognized",label:"인식 불가"},{key:"accuracy",label:"정답률(%)"},{key:"avgResponseTimeMs",label:"평균 응답시간(ms)"},{key:"replayTotal",label:"다시 듣기"}],rows)}
function renderProblemStats(rows){$("problemTab").innerHTML=tableHtml([{key:"itemId",label:"문항 ID"},{key:"audio",label:"음성파일"},{key:"answerLabel",label:"정답"},{key:"participants",label:"참가자"},{key:"responses",label:"응답"},{key:"correct",label:"정답"},{key:"incorrect",label:"오답"},{key:"unrecognized",label:"인식 불가"},{key:"accuracy",label:"정답률(%)"},{key:"avgResponseTimeMs",label:"평균 응답시간(ms)"},{key:"replayTotal",label:"다시 듣기"},{key:"distribution",label:"응답 분포"}],rows)}
